...
<body text="#FF33CC" bgcolor="#FFFF99" link="#339999" alink="#FF3300" vlink="#339999">
<div align="center">
     <H3>
        Здравствуйте,
        <br>
        <font color="#00CC00">это моя вторая страница</font> :)
    </H3>
    <br>
    Добро пожаловать! :)
</div>
