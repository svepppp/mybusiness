...
public class BasicDaoImpl<T> implements BasicDao<T> {
    ...
    public BasicDaoImpl(Class<T> entityClass) {  // entityClass доб как параметр
    ...
    public List<T> getAll() {
        ...
        return getSessionFactory().createQuery(criteriaQuery).list(); // SELECT * FROM cats
    }
